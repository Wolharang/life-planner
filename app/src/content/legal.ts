...
const PRIVACY: LegalDoc = {
  ...
  blocks: [
    ...
    {
      t: "p",
      text: "⑦ 회원이 운동 자동 판정 기능을 이용하는 경우에 한하여 위치정보가 처리됩니다. 해당 위치정보는 회원의 기기 내부에서 실행 여부를 판정하는 데에만 이용된 후 즉시 파기되며, 기관의 서버로 전송되지 아니합니다. 회원이 지정한 헬스장의 위치는 회원의 기기 내부에만 저장됩니다. 구체적인 사항은 위치기반서비스 이용약관에서 정합니다.",
    },

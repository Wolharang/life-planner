...
const TERMS: LegalDoc = {
  ...
  blocks: [
    ...
    { t: "p", text: "② 가입은 이메일 주소와 비밀번호에 의한 방법, Google 계정에 의한 방법 또는 카카오 계정에 의한 방법으로 할 수 있습니다." },
    {
      t: "p",
  ...
  blocks: [
    ...
    { t: "p", text: "① 회원 가입 및 계정 관리" },
    {
      ...
      items: [
        ...
        "카카오 계정 가입 시 (필수) : 카카오 계정 고유 식별자(회원번호)",
        "카카오 계정 가입 시 (선택) : 이메일 주소",
      ],
    },
    { t: "p", text: "② 동기화 서비스의 제공을 위하여 회원이 애플리케이션에 직접 입력한 정보" },
    {
      ...
      items: [
        ...
        "운동 자동 판정을 위하여 회원이 지정한 장소의 위치 : 위도 및 경도",
    ...
    {
      t: "p",
      text: "④ 약관 동의 이력 : 동의한 문서, 문서의 버전, 항목별 동의 일시, 연령 확인 사실, 동의한 기기의 이름 및 식별값",
    },
    {
      t: "p",
    ...
    {
      t: "p",
      text: "⑦ 운동 자동 판정 과정에서 회원의 실시간 위치정보가 수집되는 경우, 해당 위치정보는 회원의 기기 내부에서 실행 여부를 판정하는 데에만 이용된 후 즉시 파기되며, 기관의 서버로 전송되지 아니합니다. 회원이 지정한 장소의 위치(제2항)는 회원의 기기 간 동기화를 위하여 저장·처리되며, 이에 관하여는 위치기반서비스 이용약관이 함께 적용됩니다.",
    },
    {
      t: "p",
      text: "⑧ 제1항의 Google 계정 또는 카카오 계정 정보는 회원이 해당 로그인 방법을 선택하여 인증한 경우에 한하여 해당 사업자로부터 제공받습니다. 카카오 계정의 회원번호는 회원의 계정을 식별하기 위하여 처리되며, 이메일 주소는 회원이 카카오에서 이메일 제공에 동의한 경우에만 제공받아 회원의 기기 내부에 저장되고 기관의 서버에는 저장되지 아니합니다.",
    },
    ...
    { t: "p", text: "② 기관은 카카오 계정 로그인 인증의 처리를 위하여 다음과 같이 개인정보 처리업무를 위탁합니다." },
    {
      t: "list",
      items: [
        "수탁자 : Cloudflare, Inc.",
        "위탁 업무의 내용 : 카카오 로그인 인증 토큰의 교환 및 발급",
        "이용하는 서비스 : Cloudflare Workers",
        "위탁 기간 : 위탁 계약 종료 시까지이며, 인증 처리 완료 후 개인정보를 별도로 저장하지 아니합니다",
      ],
    },
    {
      t: "p",
    ...
    { t: "p", text: "① 제5조 제1항의 위탁에 따라 개인정보가 다음과 같이 국외로 이전됩니다." },
    {
      t: "list",
      items: [
        "이전받는 자 : Google LLC",
    ...
    { t: "p", text: "② 카카오 계정 로그인을 이용하는 경우 제5조 제2항의 위탁에 따라 개인정보가 다음과 같이 국외로 이전됩니다." },
    {
      t: "list",
      items: [
        "이전받는 자 : Cloudflare, Inc.",
        "이전되는 국가 : 미국",
        "이전 일시 및 방법 : 카카오 로그인 시 정보통신망을 통하여 전송",
        "이전 항목 : 카카오 계정 고유 식별자(회원번호), 회원이 동의한 경우 이메일 주소",
        "이전받는 자의 이용 목적 : 로그인 인증 토큰의 교환 및 발급",
        "이전받는 자의 보유 기간 : 인증 처리 후 파기",
      ],
    },
    {
      t: "p",
...
const LOCATION: LegalDoc = {
  ...
  blocks: [
    ...
    { t: "p", text: "① 기관이 제공하는 위치기반서비스의 내용은 다음과 같습니다." },
    {
      t: "list",
      items: [
        "1. 회원의 헬스·러닝 실행에 대하여 위치의 이동 여부 및 회원이 지정한 장소와의 일치 여부를 확인하여 그 결과를 회원 본인에게 알리는 서비스",
      ],
    },
    {
      t: "p",
    ...
    {
      t: "p",
      text: "⑤ 회원이 제1항의 판정을 위하여 지정한 장소의 위치는 기기의 위치 기능으로 수집하는 위치정보가 아니라 회원이 직접 입력·저장한 정보로서, 동기화 기능이 켜진 경우 회원의 다른 기기와 일치시키기 위하여 처리됩니다. 그 처리에 관하여는 개인정보 처리방침에 따릅니다.",
    },
    ...
    { t: "article", text: "제6조 (위치정보의 처리 및 파기)" },
    {
      t: "p",
      text: "① 기관은 위치정보를 회원의 기기 내부에서만 처리하며, 제4조 제1항의 판정 목적이 달성되면 지체 없이 파기합니다.",
    },
    {
      t: "p",
      text: "② 기관은 위치정보를 서버에 전송하지 아니하며, 위치정보나 그 이용사실을 확인할 수 있는 자료를 별도로 저장·보존하지 아니합니다.",
    },
    ...
    {
      t: "p",
      text: "③ 회원은 기기의 설정에서 위치 접근 권한을 철회하거나 자동 판정 기능을 해제함으로써 언제든지 위치정보의 수집을 중단시킬 수 있습니다.",
    },

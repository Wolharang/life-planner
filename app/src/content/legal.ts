...
const TERMS: LegalDoc = {
  ...
  blocks: [
    ...
    {
      t: "p",
      text: "③ 제2항에도 불구하고 기관은 탈퇴한 계정의 식별값과 탈퇴 일시를 개인정보 처리방침에서 정한 기간 동안 보관합니다. 이는 탈퇴 이후 회원의 다른 기기가 그 계정에 회원 데이터를 다시 올리는 것을 막기 위한 것이며, 그 밖의 목적으로 이용하지 아니합니다.",
    },
...
const PRIVACY: LegalDoc = {
  ...
  blocks: [
    ...
    {
      t: "p",
      text: "⑥ 탈퇴 기록 : 탈퇴한 계정의 식별값, 탈퇴 일시, 기기 기록의 삭제 여부. 탈퇴 이후 다른 기기가 그 계정에 회원 데이터를 다시 올리는 것을 막고 회원이 선택한 삭제 범위를 다른 기기에 전달하기 위한 최소한의 정보이며, 이름·이메일 등 회원을 알아볼 수 있는 정보는 포함하지 아니하고 다른 정보와 결합하여 이용하지 아니합니다.",
    },
    {
      t: "p",
    ...
    { t: "p", text: "① 기관은 다음 각 호의 기간 동안 개인정보를 보유합니다." },
    {
      ...
      items: [
        ...
        "4. 탈퇴 기록 : 서비스가 종료될 때까지. 이 기록을 지우면 탈퇴 이전에 연결되어 있던 기기가 그 계정에 회원 데이터를 다시 올릴 수 있으므로, 탈퇴의 효력을 유지하기 위하여 보관합니다.",
      ],
    },
    {
      t: "p",

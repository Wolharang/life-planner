...
export const NOTICES: Notice[] = [
  {
    id: "n-2026-07-16-kakao-login",
    date: "2026-07-16",
    pinned: true,
    title: "카카오 계정으로 로그인할 수 있어요 · 약관 및 처리방침 개정 안내",
    body: [
      {
        t: "p",
        text: "이제 이메일·Google에 더해 카카오 계정으로도 로그인할 수 있어요. 카카오로 로그인하면 다른 기기와 자동으로 맞춰지는 동기화가 켜져요. 로그인하지 않아도 앱의 모든 기능은 그대로 동작해요.",
      },
      {
        t: "p",
        text: "카카오 로그인을 위해 카카오로부터 회원번호를 받아 계정을 구분하고, 회원이 카카오에서 이메일 제공에 동의한 경우 이메일 주소를 받아 이 기기에만 저장해요. 인증 처리에는 Cloudflare(미국)를 이용하며, 인증이 끝나면 따로 저장하지 않아요.",
      },
      {
        t: "p",
        text: "이에 따라 서비스 이용약관과 개인정보 처리방침이 개정돼요. 개정된 처리방침에는 카카오 계정 항목(제2조), 인증 처리 위탁(제5조), 국외 이전(제6조)이 추가됐어요. 시행일은 2026년 7월 16일이며, 자세한 내용은 설정 → 약관 및 정책에서 확인할 수 있어요.",
      },
    ],
  },
  {

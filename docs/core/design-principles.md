...
- **개정 (창업자, 2026-07-11).** 실행 순간을 **커밋 → ~5분 뒤 "진짜 했어?" 재확인 → (아직 안 했어) 5·4·3·2·1 → 나가기**로
  바꿨다. 카운트다운은 이제 **커밋 직후가 아니라 재확인의 "아직 안 했어"에서** 돈다(즉시 강제 대신 5분 유예 후 재확인).
  **인-플로우 이탈구 없음·무죄책은 유지**(응/아직만; 즉시 miss 벌 없음 — 미완료는 pending→캐치업). 구현: `ExecutionActivity`,
  PRD R7. *효과(즉시 카운트다운 vs 5분 후 재확인)는 창업자 자가실험으로 검증한다.*
